    ...
    return (
        <div className='px-4'>
            <div className='container mx-auto py-4 rounded-md my-10 px-4'>
                <div className='grid grid-cols-1 md:grid-cols-3 items-center bg-[#c1d3fe] py-4 px-4 rounded-lg'>
                    <div className='col-span-2'>
                        <h1 className='text-2xl sm:text-4xl font-bold text-[#2a3254]'>
                            Find the talent needed to get your business growing.</h1>
                        <p className='text-lg py-3 text-[#2a3254] font-medium'>Upload your tasks to be viewed by numerous skilled freelancers</p>
