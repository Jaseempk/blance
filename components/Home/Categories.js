        ...
        >
          <SwiperSlide>
            <div className="bg-[#4895ef] h-60 flex items-center justify-center shadow-lg flex-col text-center rounded-md">
              ...
              <img
                className="w-28 h-28"
                src="categories/smart-contract-dev.png"
          ...
          <SwiperSlide>
            <div className="bg-[#4895ef] h-60 flex items-center justify-center shadow-lg flex-col text-center rounded-md">
              <strong className="text-xl text-[#2a3254]">Blockchain Architecture</strong>
              <img
                className="w-28 h-28"
          ...
          <SwiperSlide>
            <div className="bg-[#fce3d6] h-60 flex items-center justify-center shadow-lg flex-col text-center rounded-md">
              <strong className="text-xl text-[#2a3254]">Writing</strong>
              <img
                className="w-28 h-28"
